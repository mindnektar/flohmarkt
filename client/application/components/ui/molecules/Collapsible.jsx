...
const Collapsible = (props) => {
    ...
    const show = () => {
        ...
        timeoutRef.current = window.setTimeout(() => {
            // After the show animation is done, we need to remove the height again, because while the component is uncollapsed, the height
            // of its content might change. And if it does, a fixed height for the parent will break the layout.
            setHeight(null);
        }, 300);
    };
